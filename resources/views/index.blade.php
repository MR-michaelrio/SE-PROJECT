                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="display: flex;">
                            ...
                            <div class="row align-items-center">
                                <div class="menu-title">{{ $item->Recipe->recipe_name }}</div>
                                <div class="name-menu-title">{{ $item->User->user_name }} - {{ Carbon\Carbon::parse($item->publish_date)->format('m-d-Y') }}</div>
                            </div>

                            <div class="btn-group dropstart">
                                <button type="button" class="btn btn-menu-options" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <button type="button" class="dropdown-item" data-bs-toggle="modal"
                                            ...
                                            onclick="updatePublishId({{ $item->publish_id }})">
                                            <img src="{{ asset('asset/game-icons_grain-bundle.png') }}" alt=""
                                                srcset="" width="20px"> Add to bundle
                                        </button>
                                    </li>
                                    <li>
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="display: flex;">
                            <img src="{{ asset('asset/user.png') }}" class="menu-username" alt="" srcset="">
                            <div class="row align-items-center">
                                <div class="menu-title">{{ $item->Bundle->bundle_name }}</div>
                                <div class="name-menu-title">{{ $item->MyBundle->User->user_name }} - {{ Carbon\Carbon::parse($item->Bundle->bundle_publishdate)->format('m-d-Y') }}</div>
                            </div>
...
<div class="modal fade " id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="titlebundle d-flex justify-content-center mb-3" style="background:#617A55; color:white; font-weight:500px;">
        <span>ADD TO BUNDLE</span> 
      </div>
      <div class="container ps-4 pe-4">
        <div class="row mb-3">
            <div class="col d-flex justify-content-center align-items-center p-3 rounded-start" style="background:#617A55">
                <img src="{{ asset('asset/game-icons_grain-bundle-white.png') }}" alt="" srcset="">
            </div>
            <div class="col d-flex justify-content-center align-items-center p-3 rounded-end" style="background:rgb(97,122,85,30%)">
